import ISignUpOtpWording from "./types";

const signUpOtpWording: ISignUpOtpWording = {
  ...
  descriptionEndText: ". Le code reçu est valide pendant 5 minutes.",
  submit: "Confirmer",
...
export default signUpOtpWording;
