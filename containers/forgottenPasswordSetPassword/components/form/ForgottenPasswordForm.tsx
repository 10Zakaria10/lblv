...
import { useSetPasswordMutation } from "~containers/forgottenPasswordSetPassword/hooks";
import { isPasswordValid } from "~containers/forgottenPasswordSetPassword/services/forgottenPassword.service";
import setPasswordWording from "~containers/forgottenPasswordSetPassword/wording/wording";
import Router from "next/router";

import { Form, ListItem, SubTitle } from "./ForgottenPasswordForm.style";

const ForgottenPasswordSetPasswordForm: React.FC = () => {
...
export default ForgottenPasswordSetPasswordForm;
